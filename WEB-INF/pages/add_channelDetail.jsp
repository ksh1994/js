					...
					<div class="widget-body no-padding">
						...
						<form method="post" id='form' class="smart-form"
							...
							<fieldset>
									...
									<section class="col-3">
										用户ID: &nbsp;&nbsp;&nbsp;
										<input style="width: 15%"  type="text" id="i1" name="id" class="input-sm" placeholder="用户ID" onchange="getInfo()" />
									</section>
									<section class="col-3">
										负责人: &nbsp;&nbsp;&nbsp;
										<input  style="width: 25%" type="text" id="i2" name="username" class="input-sm" placeholder="负责人" />
									</section>
									<section class="col-3">
										联系方式: 
										<input style="width: 35%" type="text" id="i4" name="tel" class="input-sm" placeholder="联系方式" />
									</section>
